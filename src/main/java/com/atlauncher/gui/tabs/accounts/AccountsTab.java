...
public class AccountsTab extends JPanel implements Tab, RelocalizationListener {
    ...
    public AccountsTab() {
        ...
        JEditorPane infoTextPane = new JEditorPane("text/html", new HTMLBuilder().center().text(GetText.tr(
                "Данный лаунчер взломан русскими разработчиками!\n" +
                    "Чтобы скачать сборку - испльзуйте официальный!\n" +
                    "Чтобы играть и радоваться жизни на пиратских аккаунтах - используйте этот!"))
                .build());
